...
return(
  <>
    ...
    <div className="hero-wrap ftco-degree-bg" style={{backgroundImage: "url('fonts/images/bg_1.jpg')"}} data-stellar-background-ratio="0.5">
		              ...
		              <div className="form-group">
			            ...
			            <div className="form-group">
	  					...
	  					<div className="col-md-8 d-flex align-items-center">
					        ...
					        <p><a  className="btn btn-primary py-3 px-4">Reserve Your Perfect Car</a></p>
	  						</div>
	  					</div>
	  				</div>
				</div>
    				...
    				<div className="carousel-car owl-carousel">
    					<div className="item">
    						<div className="car-wrap rounded ftco-animate">
		    					<div className="img rounded d-flex align-items-end" style={{backgroundImage: "url(fonts/images/car-1.jpg)"}}>
		    					</div>
		    					<div className="text">
		    						<h2 className="mb-0"><a >Mercedes Grand Sedan</a></h2>
		    						<div className="d-flex mb-3">
			    						<span className="cat">Cheverolet</span>
			    						<p className="price ml-auto">$500 <span>/day</span></p>
		    						</div>
		    						<p className="d-flex mb-0 d-block"><a  className="btn btn-primary py-2 mr-1">Book now</a> <a  className="btn btn-secondary py-2 ml-1">Details</a></p>
		    					</div>
		    				</div>
    					</div>
    					<div className="item">
    						<div className="car-wrap rounded ftco-animate">
		    					<div className="img rounded d-flex align-items-end" style={{backgroundImage: "url(fonts/images/car-2.jpg)"}}>
		    					</div>
		    					<div className="text">
		    						<h2 className="mb-0"><a >Mercedes Grand Sedan</a></h2>
		    						<div className="d-flex mb-3">
    					...
    					<div className="item">
    						<div className="car-wrap rounded ftco-animate">
		    					<div className="img rounded d-flex align-items-end" style={{backgroundImage: "url(fonts/images/car-3.jpg)"}}>
		    					</div>
		    					<div className="text">
		    						<h2 className="mb-0"><a >Mercedes Grand Sedan</a></h2>
		    						<div className="d-flex mb-3">
    					...
    					<div className="item">
    						<div className="car-wrap rounded ftco-animate">
		    					<div className="img rounded d-flex align-items-end" style={{backgroundImage: "url(fonts/images/car-4.jpg)"}}>
		    					</div>
		    					<div className="text">
		    						<h2 className="mb-0"><a >Mercedes Grand Sedan</a></h2>
		    						<div className="d-flex mb-3">
    ...
    <section className="ftco-section ftco-about">
			<div className="container">
	          ...
	          <div className="heading-section heading-section-white pl-md-5">
	            ...
	            <p><a  className="btn btn-primary py-3 px-4">Search Vehicle</a></p>
	          </div>
					</div>
				</div>
			</div>
		...
		<section className="ftco-section ftco-intro" style={{backgroundImage: "url(fonts/images/bg_3.jpg)"}}>
			<div className="overlay"></div>
			<div className="container">
            ...
            <a  className="btn btn-primary btn-lg">Become A Driver</a>
          </div>
				</div>
			</div>
		</section>
            ...
            <div className="carousel-testimony owl-carousel ftco-owl">
              <div className="item">
                <div className="testimony-wrap rounded text-center py-4 pb-5">
                  <div className="user-img mb-2" style={{backgroundImage: "url(fonts/images/person_1.jpg)"}}>
                  </div>
              ...
              <div className="item">
                <div className="testimony-wrap rounded text-center py-4 pb-5">
                  <div className="user-img mb-2" style={{backgroundImage: "url(fonts/images/person_2.jpg)"}}>
                  </div>
                  <div className="text pt-4">
                    <p className="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                    <p className="name">Roger Scott</p>
              ...
              <div className="item">
                <div className="testimony-wrap rounded text-center py-4 pb-5">
                  <div className="user-img mb-2" style={{backgroundImage: "url(fonts/images/person_3.jpg)"}}>
                  </div>
                  <div className="text pt-4">
                    <p className="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                    <p className="name">Roger Scott</p>
      ...
      <div className="container">
        ...
        <div className="row d-flex">
          <div className="col-md-4 d-flex ftco-animate">
              ...
              <a href="blog-single.html" className="block-20" style={{backgroundImage: "url('fonts/images/image_1.jpg')"}}>
              </a>
              <div className="text pt-4">
              	<div className="meta mb-3">
                  <div><a >Oct. 29, 2019</a></div>
                  <div><a >Admin</a></div>
                  <div><a  className="meta-chat"><span className="icon-chat"></span> 3</a></div>
                </div>
                <h3 className="heading mt-2"><a >Why Lead Generation is Key for Business Growth</a></h3>
                <p><a  className="btn btn-primary">Read more</a></p>
              </div>
            </div>
          </div>
          <div className="col-md-4 d-flex ftco-animate">
          	<div className="blog-entry justify-content-end">
              <a href="blog-single.html" className="block-20" style={{backgroundImage: "url('fonts/images/image_2.jpg')"}}>
              </a>
              <div className="text pt-4">
              	<div className="meta mb-3">
                  <div><a >Oct. 29, 2019</a></div>
          ...
          <div className="col-md-4 d-flex ftco-animate">
              ...
              <a href="blog-single.html" className="block-20" style={{backgroundImage: "url('fonts/images/image_3.jpg')"}}>
              </a>
              <div className="text pt-4">
              	<div className="meta mb-3">
                  <div><a >Oct. 29, 2019</a></div>
