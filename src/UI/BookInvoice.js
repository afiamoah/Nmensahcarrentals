...
const Invoice=()=>{
    ...
    const Details=useLocation()
        ...
        function RandomKey() {
            ...
            const AllDetails=Details.state

            setBookid((AllDetails.Bookid))
            setFullname((AllDetails.Fullname))
            setTelephone((AllDetails.Telephone))
            setAddress((AllDetails.Address))
            setPurpose((AllDetails.Purpose))
            setAmount((AllDetails.Amount))
            setCartype((AllDetails.Cartype))
            setDeliveryDate((AllDetails.DeliveryDate))
            setConfirmPayment((AllDetails.ConfirmPayment))
            setBookingDate((AllDetails.BookingDate))
            setDays((AllDetails.Days))
            setEmail((AllDetails.Email))
            setService((AllDetails.Service))
            setDeliveryTime((AllDetails.DeliveryTime))
            setPaymentStatus((AllDetails.PaymentStatus))

            console.log(Details.state.Fullname)
            }
