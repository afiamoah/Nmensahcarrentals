...
import { addDoc,collection,doc,docs,getDoc } from "firebase/firestore";
import InvoiceDetails from "../Context/MyContext";
...
socket.emit("notify",{newBooking,AdminID})
  ...
  const generateInvoice=()=>{
    navigate('/invoice/',{state:{...NewDocs}})
      // const FindCode={
      //     Telephone:Telephone,
      //     Bookid:Bookid,
  ...
  const AddNewBooking=async(e)=>{
    e.preventDefault()
     NewDocs={
      Bookid,Fullname,Address,Telephone,Purpose,Amount,Cartype,BookingDate,DeliveryDate,Days,PaymentStatus,ConfirmPayment,Email,Service,DeliveryTime,ReminderDate 
    }
    try{
    	...
    	<div className="container">
    		<div className="row no-gutters">
                ...
                {/* <button onClick={test}>NOTIFY</button> */}
	  						 <form action="#" ref={form} onSubmit={AddNewBooking} className="request-form  bg-dark">
		          		<h2>Rent Now</h2>
